INTERFACE zif_pp_xls_style_changer
  PUBLIC .

  METHODS apply
    IMPORTING
      ip_worksheet   TYPE REF TO zcl_pp_xls_worksheet
  ...
  METHODS set_font_color
    IMPORTING
      value         TYPE zpps_xls_style_color
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_font_color_rgb
    IMPORTING
      value         TYPE zppe_xls_style_color_argb
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_font_color_indexed
    IMPORTING
      value         TYPE zppe_xls_style_color_indexed
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_font_color_theme
    IMPORTING
      value         TYPE zppe_xls_style_color_theme
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_font_color_tint
    IMPORTING
      value         TYPE zppe_xls_style_color_tint
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_font_family
    IMPORTING
      value         TYPE zppe_xls_style_font_family
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  ...
  METHODS set_font_name
    IMPORTING
      value         TYPE zppe_xls_style_font_name
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_font_scheme
    IMPORTING
      value         TYPE zppe_xls_style_font_scheme
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  ...
  METHODS set_font_underline_mode
    IMPORTING
      value         TYPE zppe_xls_style_font_underline
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_fill_filltype
    IMPORTING
      value         TYPE zppe_xls_fill_type
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_fill_rotation
    IMPORTING
      value         TYPE zppe_xls_rotation
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  ...
  METHODS set_fill_gradtype_type
    IMPORTING
      value         TYPE zpps_xls_gradient_type-type
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_fill_gradtype_degree
    IMPORTING
      value         TYPE zpps_xls_gradient_type-degree
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_fill_gradtype_bottom
    IMPORTING
      value         TYPE zpps_xls_gradient_type-bottom
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_fill_gradtype_left
    IMPORTING
      value         TYPE zpps_xls_gradient_type-left
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_fill_gradtype_top
    IMPORTING
      value         TYPE zpps_xls_gradient_type-top
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_fill_gradtype_right
    IMPORTING
      value         TYPE zpps_xls_gradient_type-right
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_fill_gradtype_position1
    IMPORTING
      value         TYPE zpps_xls_gradient_type-position1
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_fill_gradtype_position2
    IMPORTING
      value         TYPE zpps_xls_gradient_type-position2
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_fill_gradtype_position3
    IMPORTING
      value         TYPE zpps_xls_gradient_type-position3
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_borders_diagonal_mode
    IMPORTING
      value         TYPE zppe_xls_diagonal
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_alignment_horizontal
    IMPORTING
      value         TYPE zppe_xls_alignment
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  ...
  METHODS set_alignment_textrotation
    IMPORTING
      value         TYPE zppe_xls_text_rotation
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  ...
  METHODS set_alignment_indent
    IMPORTING
      value         TYPE zppe_xls_indent
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  METHODS set_protection_hidden
    IMPORTING
      value         TYPE zppe_xls_cell_protection
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  ...
  METHODS set_borders_top_color_tint
    ...
    RETURNING
      VALUE(result) TYPE REF TO zif_pp_xls_style_changer.
  DATA: complete_style  TYPE zpps_xls_cstyle_complete READ-ONLY,
        complete_stylex TYPE zpps_xls_cstylex_complete READ-ONLY.
ENDINTERFACE.
