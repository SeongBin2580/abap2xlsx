CLASS zcl_pp_xls_comments DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        !io_from TYPE REF TO zcl_pp_xls_comments OPTIONAL .
    METHODS get
      IMPORTING
  ...
  PRIVATE SECTION.
    ...
    DATA comments TYPE REF TO zcl_pp_xls_collection .
ENDCLASS.



CLASS zcl_pp_xls_comments IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    DATA: lo_comment  TYPE REF TO zcl_pp_xls_comment,
