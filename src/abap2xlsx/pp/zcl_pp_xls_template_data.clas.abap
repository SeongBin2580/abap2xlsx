CLASS zcl_pp_xls_template_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_sheet_titles TYPE STANDARD TABLE OF zppe_xls_sheet_title WITH DEFAULT KEY,
...
CLASS zcl_pp_xls_template_data IMPLEMENTATION.
