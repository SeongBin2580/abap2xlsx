CLASS zcl_yy_xls_styles_cond DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    METHODS add
      IMPORTING
        !ip_style_cond TYPE REF TO zcl_yy_xls_style_cond .
    METHODS clear .
    METHODS constructor .
    METHODS get
      IMPORTING
...
*"* do not include other source files here!!!
  PRIVATE SECTION.
    ...
    DATA styles_cond TYPE REF TO zcl_yy_xls_collection .
ENDCLASS.



CLASS zcl_yy_xls_styles_cond IMPLEMENTATION.
