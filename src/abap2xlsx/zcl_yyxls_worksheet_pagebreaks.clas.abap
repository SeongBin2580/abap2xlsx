CLASS zcl_yyxls_worksheet_pagebreaks DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ts_pagebreak_at ,
        ...
        cell_column TYPE zyyxls_cell_column,
...
CLASS zcl_yyxls_worksheet_pagebreaks IMPLEMENTATION.
  ...
  METHOD add_pagebreak.
    ...
    ls_pagebreak-cell_column = zcl_yyxls_common=>convert_column2int( ip_column ).
