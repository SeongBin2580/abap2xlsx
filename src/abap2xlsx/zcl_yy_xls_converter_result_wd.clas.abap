CLASS zcl_yy_xls_converter_result_wd DEFINITION
  PUBLIC
  INHERITING FROM zcl_yy_xls_converter_result
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    METHODS zif_yy_xls_converter~can_convert_object
        REDEFINITION .
    METHODS zif_yy_xls_converter~create_fieldcatalog
        REDEFINITION .
    METHODS zif_yy_xls_converter~get_supported_class
        REDEFINITION .
...
CLASS zcl_yy_xls_converter_result_wd IMPLEMENTATION.
...
* Only for WD
  ...
  METHOD zif_yy_xls_converter~get_supported_class.
    rv_supported_class = 'CL_SALV_WD_RESULT_DATA_TABLE'.
  ENDMETHOD.

  METHOD zif_yy_xls_converter~can_convert_object.
  ...
  METHOD zif_yy_xls_converter~create_fieldcatalog.
    DATA: lo_result TYPE REF TO cl_salv_wd_result_data_table,
          lo_data   TYPE REF TO data.

    FIELD-SYMBOLS: <fs_table> TYPE STANDARD TABLE.

    zif_yy_xls_converter~can_convert_object( io_object = io_object ).
