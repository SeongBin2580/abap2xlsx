CLASS zcl_yy_xls_reader_huge_file DEFINITION
  PUBLIC
  INHERITING FROM zcl_yy_xls_reader_2007
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF t_cell_content,
        datatype TYPE zyye_xls_cell_data_type,
        value    TYPE zyye_xls_cell_value,
        formula  TYPE zyye_xls_cell_formula,
        style    TYPE zyye_xls_cell_style,
      END OF t_cell_content .
    TYPES:
      BEGIN OF t_cell_coord,
        row    TYPE zyye_xls_cell_row,
        column TYPE zyye_xls_cell_column_alpha,
      END OF t_cell_coord .
    TYPES:
      BEGIN OF t_cell.
    ...
    METHODS get_style
      IMPORTING
        !iv_index            TYPE any
      RETURNING
        VALUE(ev_style_guid) TYPE zyye_xls_cell_style
      RAISING
        lcx_not_found .
...
CLASS zcl_yy_xls_reader_huge_file IMPLEMENTATION.
  ...
  METHOD load_worksheet.
    ...
    TRY.
      ...
      CATCH lcx_not_found INTO lx_not_found.
        zcx_yy_xls=>raise_text( lx_not_found->error ).
    ENDTRY.
  ENDMETHOD.
