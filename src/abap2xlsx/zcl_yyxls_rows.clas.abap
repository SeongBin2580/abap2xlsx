...
*
*----------------------------------------------------------------------*
CLASS zcl_yyxls_rows DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    METHODS add
      IMPORTING
        !io_row TYPE REF TO zcl_yyxls_row .
    METHODS clear .
    METHODS constructor .
    METHODS get
      IMPORTING
...
CLASS zcl_yyxls_rows IMPLEMENTATION.
