...
TYPES: BEGIN OF ts_subtotal_rows,
         row_int       TYPE zyyxls_cell_row,
         row_int_start TYPE zyyxls_cell_row,
...
TYPES: BEGIN OF ts_styles,
         ...
         alignment TYPE zyyxls_alignment,
...
TYPES: BEGIN OF ts_color_styles,
         guid_old  TYPE zyyxls_cell_style,
         fontcolor TYPE zyyxls_style_color_argb,
         fillcolor TYPE zyyxls_style_color_argb,
         style_new TYPE REF TO zcl_yyxls_style,
