CLASS zcl_yyxls_comments DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        !io_from TYPE REF TO zcl_yyxls_comments OPTIONAL .
    METHODS get
      IMPORTING
  ...
  PRIVATE SECTION.
    ...
    DATA comments TYPE REF TO zcl_yyxls_collection .
ENDCLASS.



CLASS zcl_yyxls_comments IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    DATA: lo_comment  TYPE REF TO zcl_yyxls_comment,
