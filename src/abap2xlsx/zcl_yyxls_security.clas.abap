CLASS zcl_yyxls_security DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA revisionspassword TYPE zyyxls_revisionspassword .
    DATA workbookpassword TYPE zyyxls_workbookpassword .
...
CLASS zcl_yyxls_security IMPLEMENTATION.
