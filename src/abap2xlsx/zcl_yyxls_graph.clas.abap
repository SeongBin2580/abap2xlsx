CLASS zcl_yyxls_graph DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
    ...
    METHODS create_serie
      IMPORTING
        ...
        !ip_lbl_from_col     TYPE zyyxls_cell_column_alpha OPTIONAL
        !ip_lbl_from_row     TYPE zyyxls_cell_row OPTIONAL
        !ip_lbl_to_col       TYPE zyyxls_cell_column_alpha OPTIONAL
        !ip_lbl_to_row       TYPE zyyxls_cell_row OPTIONAL
        !ip_lbl              TYPE string OPTIONAL
        !ip_ref_from_col     TYPE zyyxls_cell_column_alpha OPTIONAL
        !ip_ref_from_row     TYPE zyyxls_cell_row OPTIONAL
        !ip_ref_to_col       TYPE zyyxls_cell_column_alpha OPTIONAL
        !ip_ref_to_row       TYPE zyyxls_cell_row OPTIONAL
        !ip_ref              TYPE string OPTIONAL
        !ip_sername          TYPE string
        !ip_sheet            TYPE zyyxls_sheet_title OPTIONAL .
    METHODS set_style
      IMPORTING
...
CLASS zcl_yyxls_graph IMPLEMENTATION.
  ...
  METHOD create_serie.
    ...
    IF ip_lbl IS NOT SUPPLIED.
      ...
      ls_serie-lbl = zcl_yyxls_common=>escape_string( ip_value = ls_serie-lbl ).
    ...
    IF ip_ref IS NOT SUPPLIED.
      ...
      ls_serie-ref = zcl_yyxls_common=>escape_string( ip_value = ls_serie-ref ).
