CLASS zcl_yy_xls_template_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_sheet_titles TYPE STANDARD TABLE OF zyye_xls_sheet_title WITH DEFAULT KEY,
...
CLASS zcl_yy_xls_template_data IMPLEMENTATION.
