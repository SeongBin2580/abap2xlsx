CLASS zcl_yy_xls_comments DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        !io_from TYPE REF TO zcl_yy_xls_comments OPTIONAL .
    METHODS get
      IMPORTING
        !ip_index         TYPE zyye_xls_active_worksheet
      RETURNING
  ...
  PRIVATE SECTION.
    ...
    DATA comments TYPE REF TO zcl_yy_xls_collection .
ENDCLASS.



CLASS zcl_yy_xls_comments IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    DATA: lo_comment  TYPE REF TO zcl_yy_xls_comment,
