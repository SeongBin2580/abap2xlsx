CLASS zcl_yy_xls_security DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA revisionspassword TYPE zyye_xls_revisionspassword .
    DATA workbookpassword TYPE zyye_xls_workbookpassword .
...
CLASS zcl_yy_xls_security IMPLEMENTATION.
