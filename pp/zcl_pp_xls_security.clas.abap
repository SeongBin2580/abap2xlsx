CLASS zcl_pp_xls_security DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA revisionspassword TYPE zppe_xls_revisionspassword .
    DATA workbookpassword TYPE zppe_xls_workbookpassword .
...
CLASS zcl_pp_xls_security IMPLEMENTATION.
