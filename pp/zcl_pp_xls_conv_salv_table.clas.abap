CLASS zcl_pp_xls_conv_salv_table DEFINITION
  PUBLIC
  INHERITING FROM zcl_pp_xls_converter_alv
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_pp_xls_conv_salv_table IMPLEMENTATION.
...
* First update metadata if we can.
    IF io_salv->is_offline( ) = abap_false.
      ...
      ELSE.
        IF zcl_pp_xls_conv_salv_model=>is_get_metadata_callable( io_salv ) = abap_true.
