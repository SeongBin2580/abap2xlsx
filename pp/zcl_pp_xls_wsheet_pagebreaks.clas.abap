CLASS zcl_pp_xls_wsheet_pagebreaks DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ts_pagebreak_at ,
        ...
        cell_column TYPE zppe_xls_cell_column,
...
CLASS zcl_pp_xls_wsheet_pagebreaks IMPLEMENTATION.
  ...
  METHOD add_pagebreak.
    ...
    ls_pagebreak-cell_column = zcl_pp_xls_common=>convert_column2int( ip_column ).
