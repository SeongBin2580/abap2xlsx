...
TYPES: BEGIN OF ts_sort_values,
         ...
         row_int      TYPE zppe_xls_cell_row,
...
TYPES: BEGIN OF ts_subtotal_rows,
         row_int       TYPE zppe_xls_cell_row,
         row_int_start TYPE zppe_xls_cell_row,
...
TYPES: BEGIN OF ts_styles,
         ...
         alignment TYPE zppe_xls_alignment,
...
TYPES: BEGIN OF ts_color_styles,
         guid_old  TYPE zppe_xls_cell_style,
         fontcolor TYPE zppe_xls_style_color_argb,
         fillcolor TYPE zppe_xls_style_color_argb,
         style_new TYPE REF TO zcl_pp_xls_style,
