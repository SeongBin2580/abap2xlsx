CLASS zcl_pp_xls_autofilters DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ts_autofilter,
        ...
        autofilter TYPE REF TO zcl_pp_xls_autofilter,
...
CLASS zcl_pp_xls_autofilters IMPLEMENTATION.
  ...
  METHOD add.
    ...
    IF sy-subrc = 0.
      RAISE EXCEPTION TYPE zcx_pp_xls. " adding another autofilter to sheet is not allowed
    ENDIF.
